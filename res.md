...
| 商城、交易、拼团 | 完整成交闭环不做；本阶段仅有**个人出售橱窗 + 浏览在售**（独立 `market_listing`，与私库弱关联） |
| 再贩提醒、市价追踪 | 依赖外部数据源 |
